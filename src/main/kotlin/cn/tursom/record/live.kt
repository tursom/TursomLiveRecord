  ...
  liveProvider.onException = {
    ...
    while (true) {
      ...
      try {
        ...
        liveProvider = BilibiliLiveProvider(roomId, onException = onException)
        ...
        liveSaver = FileLiveSaver("record/$title-${dateFormat.now()}.flv",
          dataChannel = liveProvider.dataChannel,
          maxSize = fileMaxSize,
